...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posPurchaseDetail.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posPurchaseDetail/${_action}/${posPurchaseDetail.id}' enctype='multipart/form-data' commandName='posPurchaseDetail' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posPurchaseMaster_caption'>${posPurchaseDetail.posPurchaseMaster.remarks}</label>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posProduct_caption'>${posPurchaseDetail.posProduct.fullName}</label>
        ...
        <div class='form-group'>
            ...
            <form:errors path='lineTotal' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posPurchaseDetail.id !=null}">
                                    <sec:authorize url='/posPurchaseDetail/show'>
                                        <a href='${context}/posPurchaseDetail/show/${posPurchaseDetail.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posPurchaseDetail/edit/${posPurchaseDetail.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posPurchaseDetail/copy/${posPurchaseDetail.id}'>
                                            <button type='submit' class='btn btn-warning' >
