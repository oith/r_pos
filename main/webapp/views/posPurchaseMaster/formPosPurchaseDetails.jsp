...
<div class='col-xs-1 col-sm-1 col-md-1 col-lg-12'>
    <div class='form-group'>
        ...
        <c:choose>
            <c:when test="${posPurchaseMaster.posPurchaseDetails.size() > 0}">
                <c:forEach items='${posPurchaseMaster.posPurchaseDetails}' var='posPurchaseDetails' varStatus='varStatus'>
                    <div class="box box-info childOneDetails">
                        <div class="box-body">

                            <jsp:include page='form_PosPurchaseDetails.jsp'>
