...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posPurchaseMaster.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posPurchaseMaster/${_action}/${posPurchaseMaster.id}' enctype='multipart/form-data' commandName='posPurchaseMaster' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='authUserTransBy_caption'>${posPurchaseMaster.authUserTransBy.fullName}</label>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posSupplier_caption'>${posPurchaseMaster.posSupplier.fullName}</label>
            <form:errors path='posSupplier' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='paidAmount'><spring:message code='paidAmount' text='Paid Amount'/></form:label>
            <form:input class='form-control' path='paidAmount' type='number' required='true' min='-9223372036854775808' max='9223372036854775807' step='any'/>
            <form:errors path='paidAmount' cssClass='error' element='div'/>
        </div>
    </div>

                            </div>
                        </div>
                            <div><jsp:include page='formPosPurchaseDetails.jsp' /></div>

                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posPurchaseMaster.id !=null}">
                                    <sec:authorize url='/posPurchaseMaster/show'>
                                        <a href='${context}/posPurchaseMaster/show/${posPurchaseMaster.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posPurchaseMaster/edit/${posPurchaseMaster.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posPurchaseMaster/copy/${posPurchaseMaster.id}'>
                                            <button type='submit' class='btn btn-warning' >
