    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${authQuestion.id !=null}">
                    ...
                    <sec:authorize url='/authQuestion/index'>
                        <li>
                            <a href='${context}/authQuestion/index' class='btn btn-block btn-info btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/authQuestion/${_action}/${authQuestion.id}' enctype='multipart/form-data' commandName='authQuestion' method='POST'>
                        <div class='box-body'>
        ...
        <div class='form-group'>
            ...
            <form:errors path='question' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${authQuestion.id !=null}">
                                    <sec:authorize url='/authQuestion/show'>
                                        <a href='${context}/authQuestion/show/${authQuestion.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/authQuestion/edit/${authQuestion.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/authQuestion/copy/${authQuestion.id}'>
                                            <button type='submit' class='btn btn-warning' >
