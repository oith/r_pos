...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posSupplier/${_action}/${posSupplier.id}' enctype='multipart/form-data' commandName='posSupplier' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='emPosSupplierGroup'><spring:message code='emPosSupplierGroup' text='Em Pos Supplier Group'/></form:label>
            <form:select class='form-control' path='emPosSupplierGroup' name='emPosSupplierGroup' id='emPosSupplierGroup' required='true' >
                <form:option value='GRADE_A' label='GRADE A'/>
                <form:option value='GRADE_B' label='GRADE B'/>
                <form:option value='GRADE_C' label='GRADE C'/>
            </form:select>
            <form:errors path='emPosSupplierGroup' cssClass='error' element='div'/>
        </div>
    </div>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posSupplier.id !=null}">
                                    <sec:authorize url='/posSupplier/show'>
                                        <a href='${context}/posSupplier/show/${posSupplier.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posSupplier/edit/${posSupplier.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posSupplier/copy/${posSupplier.id}'>
                                            <button type='submit' class='btn btn-warning' >
