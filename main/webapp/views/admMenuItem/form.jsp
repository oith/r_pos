...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admMenuItem/${_action}/${admMenuItem.id}' enctype='multipart/form-data' commandName='admMenuItem' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:input class='form-control' path='displayIconClass' type='text' size='30' maxlength='100'/>
            <form:errors path='displayIconClass' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='isExternal'><spring:message code='isExternal' text='Is External'/></form:label>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='isOpenInNewTab'><spring:message code='isOpenInNewTab' text='Is Open In New Tab'/></form:label>
            <br><form:checkbox class='cb' path='isOpenInNewTab'/>
            <form:errors path='isOpenInNewTab' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='admMenu'><spring:message code='admMenu' text='Adm Menu'/></form:label>
            <form:input class='form-control' path='admMenu.code' required='true' onkeyup='getCodableDTOAdmMenu(this.value,"admMenu_caption")' type='text' size='8'/>
            <label id='admMenu_caption'>${admMenuItem.admMenu.fullName}</label>
            <form:errors path='admMenu' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='urlPath'><spring:message code='urlPath' text='Url Path'/></form:label>
            <form:input class='form-control' path='urlPath' type='text' required='true' size='30' maxlength='100'/>
            <form:errors path='urlPath' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admMenuItem.id !=null}">
                                    <sec:authorize url='/admMenuItem/show'>
                                        <a href='${context}/admMenuItem/show/${admMenuItem.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admMenuItem/edit/${admMenuItem.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admMenuItem/copy/${admMenuItem.id}'>
                                            <button type='submit' class='btn btn-warning' >
    ...
    function getCodableDTOAdmMenu(code, lblCaption){
        $.ajax({
            type: 'GET',
            url: '${pageContext.request.contextPath}/admMenu/getCodableDTO',
            data: {code: code},
            success: function (d) {
                //alert('ok codeable: '+d);
                $('#' + lblCaption).text(d);
