        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    ...
                    <sec:authorize url='/posWarehouse/index'>
                        <li>
                            <a href='${context}/posWarehouse/index' class='btn btn-block btn-info btn-xs'>
                ...
                <div class='box box-primary'>
                    <div class='box-body'>
                        <fieldset class='show-page'>
                            ...
                            <ol class='property-list'>
                                ...
                                <c:if test='${posWarehouse.code!=null && !posWarehouse.code.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='code' text='Code'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='code'>
                                            <c:out value='${posWarehouse.code}'/>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${posWarehouse.fullName!=null && !posWarehouse.fullName.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='fullName' text='Full Name'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='fullName'>
                                            <c:out value='${posWarehouse.fullName}'/>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${posWarehouse.address!=null && !posWarehouse.address.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='address' text='Address'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='address'>
                                            <c:out value='${posWarehouse.address}'/>
                                        </span>
                                    </li>
                                </c:if>
                    ...
                    <div class='box-footer'>
                        <sec:authorize url='/posWarehouse/edit'>
                            <a href='${context}/posWarehouse/edit/${posWarehouse.id}' class='btn btn-primary'>
                                <i class='fa fa-edit'></i>
                                <spring:message code='default.button.edit.label'/>
                            </a> 
                        </sec:authorize>
                        <sec:authorize url='/posWarehouse/copy'>
                            <a href='${context}/posWarehouse/copy/${posWarehouse.id}' class='btn btn-warning'>
                        ...
                        <sec:authorize url='/posWarehouse/delete'>
                            ...
                            <a href='${context}/posWarehouse/delete/${posWarehouse.id}' class='btn btn-danger' onclick="return confirm('${confirmToDelete}');">
