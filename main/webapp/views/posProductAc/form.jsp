    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posProductAc.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posProductAc/${_action}/${posProductAc.id}' enctype='multipart/form-data' commandName='posProductAc' method='POST'>
                        <div class='box-body'>
        ...
        <div class='form-group'>
            ...
            <form:errors path='emPosAnalysisCode' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posProductAc.id !=null}">
                                    <sec:authorize url='/posProductAc/show'>
                                        <a href='${context}/posProductAc/show/${posProductAc.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posProductAc/edit/${posProductAc.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posProductAc/copy/${posProductAc.id}'>
                                            <button type='submit' class='btn btn-warning' >
