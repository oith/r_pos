...
<spring:message code='authUserAuthQuestions' text='Auth User Auth Questions'/> | <a
        href='${context}/authUserAuthQuestion/create'><spring:message
        ...
        <table class='table table-bordered table-striped table-hover table-condensed dt-responsive display nowrap th-center'>
            ...
            <c:forEach items='${authUser.authUserAuthQuestions}' var='authUserAuthQuestions' varStatus='loopStatus'>
                <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                    <td>
                        <a href='${context}/authUserAuthQuestion/show/<c:out value='${authUserAuthQuestions.id}'/>'><spring:message
                                code='show.link.label'/></a></td>
                    <td><c:out value='${authUserAuthQuestions.id}'/></td>
                    <td><c:out value='${authUserAuthQuestions.answer}'/></td>

                    <td>
                        <a href='${context}/authUserAuthQuestion/edit/<c:out value='${authUserAuthQuestions.id}'/>'><spring:message
                                code='default.button.edit.label'/></a></td>
                    <td><a href='${context}/authUserAuthQuestion/delete/<c:out value='${authUserAuthQuestions.id}'/>'
