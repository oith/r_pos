...
<html>
    <head>
        ...
        <spring:message code="posAdjustmentDetail.label" text='Pos Adjustment Detail' var="entityName"/>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posAdjustmentDetail.id !=null}">
                        <sec:authorize url='/posAdjustmentDetail/create'>
                            <li>
                                <a href='${context}/posAdjustmentDetail/create' class='btn btn-block btn-primary btn-xs'>
                    ...
                    <sec:authorize url='/posAdjustmentDetail/index'>
                        <li>
                            <a href='${context}/posAdjustmentDetail/index' class='btn btn-block btn-info btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posAdjustmentDetail/${_action}/${posAdjustmentDetail.id}' enctype='multipart/form-data' commandName='posAdjustmentDetail' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='posAdjustmentMaster'><spring:message code='posAdjustmentMaster' text='Pos Adjustment Master'/></form:label>
            <form:input class='form-control' path='posAdjustmentMaster.code' required='true' onkeyup='getCodableDTOPosAdjustmentMaster(this.value,"posAdjustmentMaster_caption")' type='text' size='8'/>
            <label id='posAdjustmentMaster_caption'>${posAdjustmentDetail.posAdjustmentMaster.remarks}</label>
            <form:errors path='posAdjustmentMaster' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posProduct_caption'>${posAdjustmentDetail.posProduct.fullName}</label>
        ...
        <div class='form-group'>
            ...
            <form:errors path='lineTotal' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posAdjustmentDetail.id !=null}">
                                    <sec:authorize url='/posAdjustmentDetail/show'>
                                        <a href='${context}/posAdjustmentDetail/show/${posAdjustmentDetail.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posAdjustmentDetail/edit/${posAdjustmentDetail.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posAdjustmentDetail/copy/${posAdjustmentDetail.id}'>
                                            <button type='submit' class='btn btn-warning' >
    ...
    function getCodableDTOPosAdjustmentMaster(code, lblCaption){
        $.ajax({
            type: 'GET',
            url: '${pageContext.request.contextPath}/posAdjustmentMaster/getCodableDTO',
            data: {code: code},
            success: function (d) {
                //alert('ok codeable: '+d);
                $('#' + lblCaption).text(d);
