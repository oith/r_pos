        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    ...
                    <sec:authorize url='/admModule/index'>
                        <li>
                            <a href='${context}/admModule/index' class='btn btn-block btn-info btn-xs'>
                ...
                <div class='box box-primary'>
                    <div class='box-body'>
                        <fieldset class='show-page'>
                            ...
                            <ol class='property-list'>
                                ...
                                <c:if test='${admModule.description!=null && !admModule.description.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='description' text='Description'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='description'>
                                            <c:out value='${admModule.description}'/>
                                        </span>
                                    </li>
                                </c:if>

                            </ol>
                            <div><jsp:include page='showAdmSubModules.jsp' /></div>
                    ...
                    <div class='box-footer'>
                        <sec:authorize url='/admModule/edit'>
                            <a href='${context}/admModule/edit/${admModule.id}' class='btn btn-primary'>
                                <i class='fa fa-edit'></i>
                                <spring:message code='default.button.edit.label'/>
                            </a> 
                        </sec:authorize>
                        <sec:authorize url='/admModule/copy'>
                            <a href='${context}/admModule/copy/${admModule.id}' class='btn btn-warning'>
                        ...
                        <sec:authorize url='/admModule/delete'>
                            ...
                            <a href='${context}/admModule/delete/${admModule.id}' class='btn btn-danger' onclick="return confirm('${confirmToDelete}');">
