        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admModule/${_action}/${admModule.id}' enctype='multipart/form-data' commandName='admModule' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:errors path='description' cssClass='error' element='div'/>
                            ...
                            <div><jsp:include page='formAdmSubModules.jsp' /></div>

                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admModule.id !=null}">
                                    <sec:authorize url='/admModule/show'>
                                        <a href='${context}/admModule/show/${admModule.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admModule/edit/${admModule.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admModule/copy/${admModule.id}'>
                                            <button type='submit' class='btn btn-warning' >
