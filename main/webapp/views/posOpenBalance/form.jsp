...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posOpenBalance.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posOpenBalance/${_action}/${posOpenBalance.id}' enctype='multipart/form-data' commandName='posOpenBalance' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='onDate'><spring:message code='onDate' text='On Date'/></form:label>
            <div class='input-group'>
                <div class='input-group-addon'><i class='fa fa-calendar'></i></div>
                <form:input class='form-control dtp-date' path='onDate' required='true'  />
             </div>
            <form:errors path='onDate' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posProduct_caption'>${posOpenBalance.posProduct.fullName}</label>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='emPosSign'><spring:message code='emPosSign' text='Em Sign'/></form:label>
            <form:select class='form-control' path='emPosSign' name='emPosSign' id='emPosSign' required='true' >
                <form:option value='DR' label='DR'/>
                <form:option value='CR' label='CR'/>
            </form:select>
            <form:errors path='emPosSign' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:errors path='amount' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posOpenBalance.id !=null}">
                                    <sec:authorize url='/posOpenBalance/show'>
                                        <a href='${context}/posOpenBalance/show/${posOpenBalance.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posOpenBalance/edit/${posOpenBalance.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posOpenBalance/copy/${posOpenBalance.id}'>
                                            <button type='submit' class='btn btn-warning' >
