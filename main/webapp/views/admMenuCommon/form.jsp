    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${admMenuCommon.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admMenuCommon/${_action}/${admMenuCommon.id}' enctype='multipart/form-data' commandName='admMenuCommon' method='POST'>
                        <div class='box-body'>
        ...
        <div class='form-group'>
            ...
            <form:errors path='admSubModule' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admMenuCommon.id !=null}">
                                    <sec:authorize url='/admMenuCommon/show'>
                                        <a href='${context}/admMenuCommon/show/${admMenuCommon.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admMenuCommon/edit/${admMenuCommon.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admMenuCommon/copy/${admMenuCommon.id}'>
                                            <button type='submit' class='btn btn-warning' >
