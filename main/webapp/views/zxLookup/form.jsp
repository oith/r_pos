...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/zxLookup/${_action}/${zxLookup.id}' enctype='multipart/form-data' commandName='zxLookup' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='titleNative'><spring:message code='titleNative' text='Title Native'/></form:label>
            <form:textarea class='form-control' path='titleNative' type='text' size='30' maxlength='500'/>
            <form:errors path='titleNative' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:input class='form-control' path='slNo' type='number' min='-60' max='80'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='zxLookupKeyword'><spring:message code='zxLookupKeyword' text='Zx Lookup Keyword'/></form:label>
            <form:select class='form-control' path='zxLookupKeyword' name='zxLookupKeyword' id='zxLookupKeyword' >
                <form:option value='EDUCATION_LEVEL' label='EDUCATION LEVEL'/>
            ...
            <form:errors path='zxLookupKeyword' cssClass='error' element='div'/>
        </div>
    </div>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${zxLookup.id !=null}">
                                    <sec:authorize url='/zxLookup/show'>
                                        <a href='${context}/zxLookup/show/${zxLookup.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/zxLookup/edit/${zxLookup.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/zxLookup/copy/${zxLookup.id}'>
                                            <button type='submit' class='btn btn-warning' >
