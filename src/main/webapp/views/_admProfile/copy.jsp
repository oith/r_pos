...
<html>
<head>
    <title><spring:message code='default.button.copy.label' text='Copy'/>&nbsp;<spring:message code='authUser'
...
<div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
    ...
    <section class='content-header'><!-- Content Header (Page header) -->
        <h1><spring:message code='default.button.copy.label' text='Copy'/>&nbsp;<spring:message code='authUser'
                                                                                                text='Auth User'/></h1>
        <ul class='top-links'>
    ...
    <section class='content'><!-- Main content -->
        <div class='box box-primary'>
            <form:form action='${pageContext.request.contextPath}/authUser/copy/${authUser.id}'
                    ...
                    <sec:authorize url='/authUser/copy/${authUser.id}'>
                        <button type='submit' class='btn btn-warning'>
                            <i class='fa fa-clone' aria-hidden='true'></i> <spring:message
                                code='default.button.copy.label' text='Copy'/>
                        </button>
                    </sec:authorize>
                </div>
            </form:form>
