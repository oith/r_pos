...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posAdjustmentMaster.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posAdjustmentMaster/${_action}/${posAdjustmentMaster.id}' enctype='multipart/form-data' commandName='posAdjustmentMaster' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='authUserTransBy_caption'>${posAdjustmentMaster.authUserTransBy.fullName}</label>
            <form:errors path='authUserTransBy' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posAdjustmentMaster.id !=null}">
                                    <sec:authorize url='/posAdjustmentMaster/show'>
                                        <a href='${context}/posAdjustmentMaster/show/${posAdjustmentMaster.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posAdjustmentMaster/edit/${posAdjustmentMaster.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posAdjustmentMaster/copy/${posAdjustmentMaster.id}'>
                                            <button type='submit' class='btn btn-warning' >
