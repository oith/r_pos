...
<c:if test='${not empty posAdjustmentMaster.posAdjustmentDetails}'>
    <div class='box-body table-responsive no-padding'>
        <table class='table table-bordered table-striped table-hover table-condensed dt-responsive display nowrap th-center'>
            ...
            <tbody>
                ...
                <c:forEach items='${posAdjustmentMaster.posAdjustmentDetails}' var='posAdjustmentDetails'  varStatus='loopStatus'>
