...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admMenu/${_action}/${admMenu.id}' enctype='multipart/form-data' commandName='admMenu' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='urlPath'><spring:message code='urlPath' text='Url Path'/></form:label>
            <form:input class='form-control' path='urlPath' type='text' size='30' maxlength='100'/>
            <form:errors path='urlPath' cssClass='error' element='div'/>
                            ...
                            <div><jsp:include page='formAdmMenuItems.jsp' /></div>

                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admMenu.id !=null}">
                                    <sec:authorize url='/admMenu/show'>
                                        <a href='${context}/admMenu/show/${admMenu.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admMenu/edit/${admMenu.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admMenu/copy/${admMenu.id}'>
                                            <button type='submit' class='btn btn-warning' >
