...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${authRequestMap.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/authRequestMap/${_action}/${authRequestMap.id}' enctype='multipart/form-data' commandName='authRequestMap' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='configAttribute'><spring:message code='configAttribute' text='Config Attribute'/></form:label>
            <form:textarea class='form-control' path='configAttribute' type='text' required='true' size='30' maxlength='255'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='url'><spring:message code='url' text='Url'/></form:label>
            <form:textarea class='form-control' path='url' type='text' required='true' size='30' maxlength='255'/>
            <form:errors path='url' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${authRequestMap.id !=null}">
                                    <sec:authorize url='/authRequestMap/show'>
                                        <a href='${context}/authRequestMap/show/${authRequestMap.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/authRequestMap/edit/${authRequestMap.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/authRequestMap/copy/${authRequestMap.id}'>
                                            <button type='submit' class='btn btn-warning' >
