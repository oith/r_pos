        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/zxAnyObject/${_action}/${zxAnyObject.id}' enctype='multipart/form-data' commandName='zxAnyObject' method='POST'>
                        <div class='box-body'>
        ...
        <div class='form-group'>
            ...
            <form:errors path='slNo' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${zxAnyObject.id !=null}">
                                    <sec:authorize url='/zxAnyObject/show'>
                                        <a href='${context}/zxAnyObject/show/${zxAnyObject.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/zxAnyObject/edit/${zxAnyObject.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/zxAnyObject/copy/${zxAnyObject.id}'>
                                            <button type='submit' class='btn btn-warning' >
