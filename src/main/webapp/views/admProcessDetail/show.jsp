        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    ...
                    <sec:authorize url='/admProcessDetail/index'>
                        <li>
                            <a href='${context}/admProcessDetail/index' class='btn btn-block btn-info btn-xs'>
                ...
                <div class='box box-primary'>
                    <div class='box-body'>
                        <fieldset class='show-page'>
                            ...
                            <ol class='property-list'>
                                ...
                                <c:if test='${admProcessDetail.admProcess!=null}'>
                                    <li class='fieldcontain first_item'>
                                        ...
                                        <span class='property-value' aria-labelledby='admProcess'>
                                            <c:out value='${admProcessDetail.admProcess!=null ? admProcessDetail.admProcess :"N/A"}'/>
                                        </span>
                                    </li>
                                </c:if>
                                ...
                                <c:if test='${admProcessDetail.zoneType!=null}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='zoneType' text='Zone Type'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='zoneType'>
                                            <c:out value='${admProcessDetail.zoneType}'/>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${admProcessDetail.isActive!=null}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='isActive' text='Is Active'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='isActive'>
                                            <c:if test='${admProcessDetail.isActive}'><spring:message code='default.boolean.true' text='YES'/></c:if><c:if test='${!admProcessDetail.isActive}'><spring:message code='default.boolean.false' text='NO'/></c:if>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${admProcessDetail.isMandatory!=null}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='isMandatory' text='Is Mandatory'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='isMandatory'>
                                            <c:if test='${admProcessDetail.isMandatory}'><spring:message code='default.boolean.true' text='YES'/></c:if><c:if test='${!admProcessDetail.isMandatory}'><spring:message code='default.boolean.false' text='NO'/></c:if>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${admProcessDetail.defaultVal!=null && !admProcessDetail.defaultVal.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='defaultVal' text='Default Val'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='defaultVal'>
                                            <c:out value='${admProcessDetail.defaultVal}'/>
                                        </span>
                                    </li>
                                </c:if>

                                <c:if test='${admProcessDetail.helpText!=null && !admProcessDetail.helpText.isEmpty()}'>
                                    <li class='fieldcontain first_item'>
                                        <span id='title' class='property-label'>
                                            <spring:message code='helpText' text='Help Text'/>: 
                                        </span>
                                        <span class='property-value' aria-labelledby='helpText'>
                                            <c:out value='${admProcessDetail.helpText}'/>
                                        </span>
                                    </li>
                                </c:if>
                    ...
                    <div class='box-footer'>
                        <sec:authorize url='/admProcessDetail/edit'>
                            <a href='${context}/admProcessDetail/edit/${admProcessDetail.id}' class='btn btn-primary'>
                                <i class='fa fa-edit'></i>
                                <spring:message code='default.button.edit.label'/>
                            </a> 
                        </sec:authorize>
                        <sec:authorize url='/admProcessDetail/copy'>
                            <a href='${context}/admProcessDetail/copy/${admProcessDetail.id}' class='btn btn-warning'>
                        ...
                        <sec:authorize url='/admProcessDetail/delete'>
                            ...
                            <a href='${context}/admProcessDetail/delete/${admProcessDetail.id}' class='btn btn-danger' onclick="return confirm('${confirmToDelete}');">
