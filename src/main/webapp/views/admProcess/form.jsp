...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admProcess/${_action}/${admProcess.id}' enctype='multipart/form-data' commandName='admProcess' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:textarea class='form-control' path='cmd' type='text' required='true' size='30' maxlength='2000'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:textarea class='form-control' path='query' type='text' size='30' maxlength='2000'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:errors path='processBtns' cssClass='error' element='div'/>
                            ...
                            <div><jsp:include page='formAdmProcessDetails.jsp' /></div>

                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admProcess.id !=null}">
                                    <sec:authorize url='/admProcess/show'>
                                        <a href='${context}/admProcess/show/${admProcess.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admProcess/edit/${admProcess.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admProcess/copy/${admProcess.id}'>
                                            <button type='submit' class='btn btn-warning' >
