...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${zxEmpTrainingDtl.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/zxEmpTrainingDtl/${_action}/${zxEmpTrainingDtl.id}' enctype='multipart/form-data' commandName='zxEmpTrainingDtl' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='zxEmp_caption'>${zxEmpTrainingDtl.zxEmp.fullName}</label>
            <form:errors path='zxEmp' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='zxLookupTraining'><spring:message code='zxLookupTraining' text='Zx Lookup Training'/></form:label>
            <form:select class='form-control' path='zxLookupTraining' name='zxLookupTraining' id='zxLookupTraining' required='true' >
                <form:options items='${zxLookupTrainings}' itemValue='id'/>
            </form:select>
            <form:errors path='zxLookupTraining' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='trainingOrg'><spring:message code='trainingOrg' text='Training Org'/></form:label>
            <form:input class='form-control' path='trainingOrg' type='text' required='true' size='30' maxlength='20'/>
            <form:errors path='trainingOrg' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
...
<c:url var='certificate' value='/zxEmpTrainingDtl/getFile/${zxEmpTrainingDtl.certificate}'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='zxEmpWhoCheckedBy_caption'>${zxEmpTrainingDtl.zxEmpWhoCheckedBy.fullName}</label>
            <form:errors path='zxEmpWhoCheckedBy' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${zxEmpTrainingDtl.id !=null}">
                                    <sec:authorize url='/zxEmpTrainingDtl/show'>
                                        <a href='${context}/zxEmpTrainingDtl/show/${zxEmpTrainingDtl.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/zxEmpTrainingDtl/edit/${zxEmpTrainingDtl.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/zxEmpTrainingDtl/copy/${zxEmpTrainingDtl.id}'>
                                            <button type='submit' class='btn btn-warning' >
