...
<spring:message code='admReports' text='Adm Reports'/> | <a href='${context}/admReport/create'><spring:message code='create.link.label'/>&NonBreakingSpace;<spring:message code='AdmReport' text='Adm Report'/></a>
            ...
            <tbody>
                ...
                <c:forEach items='${admModule.admReports}' var='admReports'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        <td><a href='${context}/admReport/show/<c:out value='${admReports.id}'/>'><spring:message code='show.link.label'/></a></td>
                        ...
                        <td class='center'><c:if test='${admReports.isActive}'><spring:message code='default.boolean.true' text='YES'/></c:if><c:if test='${!admReports.isActive}'><spring:message code='default.boolean.false' text='NO'/></c:if></td>
                        ...
                        <td><a href='${context}/admReport/edit/<c:out value='${admReports.id}'/>'><spring:message code='edit.link.label'/></a></td>
                        <td><a href='${context}/admReport/delete/<c:out value='${admReports.id}'/>' onclick="return confirm('${confirmToDelete}');"><spring:message code='delete.link.label'/></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
