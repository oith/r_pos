...
<div class='col-xs-1 col-sm-1 col-md-1 col-lg-12'>
    <div class='form-group'>
        ...
        <c:choose>
            <c:when test="${zxEmp.zxEmpTrainingDtls.size() > 0}">
                <c:forEach items='${zxEmp.zxEmpTrainingDtls}' var='zxEmpTrainingDtls' varStatus='varStatus'>
                    <div class="box box-info childOneDetails">
                        <div class="box-body">

                            <jsp:include page='form_ZxEmpTrainingDtls.jsp'>
