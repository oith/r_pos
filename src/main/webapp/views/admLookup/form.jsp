...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/admLookup/${_action}/${admLookup.id}' enctype='multipart/form-data' commandName='admLookup' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='lookupKeyword'><spring:message code='lookupKeyword' text='Lookup Keyword'/></form:label>
            <form:select class='form-control' path='lookupKeyword' name='lookupKeyword' id='lookupKeyword' >
                ...
                <form:option value='NATIONALITY' label='NATIONALITY'/>
            </form:select>
        ...
        <div class='form-group'>
            ...
            <form:errors path='remarks' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${admLookup.id !=null}">
                                    <sec:authorize url='/admLookup/show'>
                                        <a href='${context}/admLookup/show/${admLookup.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/admLookup/edit/${admLookup.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/admLookup/copy/${admLookup.id}'>
                                            <button type='submit' class='btn btn-warning' >
