...
<html>
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/zxDept/${_action}/${zxDept.id}' enctype='multipart/form-data' commandName='zxDept' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:input class='form-control' path='titleNative' type='text' size='30' maxlength='100'/>
        ...
        <div class='form-group'>
            ...
            <form:errors path='remarks' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${zxDept.id !=null}">
                                    <sec:authorize url='/zxDept/show'>
                                        <a href='${context}/zxDept/show/${zxDept.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/zxDept/edit/${zxDept.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/zxDept/copy/${zxDept.id}'>
                                            <button type='submit' class='btn btn-warning' >
