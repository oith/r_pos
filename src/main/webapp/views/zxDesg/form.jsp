        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/zxDesg/${_action}/${zxDesg.id}' enctype='multipart/form-data' commandName='zxDesg' method='POST'>
                        <div class='box-body'>
        ...
        <div class='form-group'>
            ...
            <form:errors path='remarks' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${zxDesg.id !=null}">
                                    <sec:authorize url='/zxDesg/show'>
                                        <a href='${context}/zxDesg/show/${zxDesg.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/zxDesg/edit/${zxDesg.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/zxDesg/copy/${zxDesg.id}'>
                                            <button type='submit' class='btn btn-warning' >
