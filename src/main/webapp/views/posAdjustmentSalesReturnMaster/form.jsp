...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${posAdjustmentSalesReturnMaster.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/posAdjustmentSalesReturnMaster/${_action}/${posAdjustmentSalesReturnMaster.id}' enctype='multipart/form-data' commandName='posAdjustmentSalesReturnMaster' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='authUserTransBy_caption'>${posAdjustmentSalesReturnMaster.authUserTransBy.fullName}</label>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <label id='posSalesMaster_caption'>${posAdjustmentSalesReturnMaster.posSalesMaster.remarks}</label>
            <form:errors path='posSalesMaster' cssClass='error' element='div'/>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${posAdjustmentSalesReturnMaster.id !=null}">
                                    <sec:authorize url='/posAdjustmentSalesReturnMaster/show'>
                                        <a href='${context}/posAdjustmentSalesReturnMaster/show/${posAdjustmentSalesReturnMaster.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/posAdjustmentSalesReturnMaster/edit/${posAdjustmentSalesReturnMaster.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/posAdjustmentSalesReturnMaster/copy/${posAdjustmentSalesReturnMaster.id}'>
                                            <button type='submit' class='btn btn-warning' >
