...
<div class='col-xs-1 col-sm-1 col-md-1 col-lg-12'>
    <div class='form-group'>
        ...
        <c:choose>
            <c:when test="${posAdjustmentSalesReturnMaster.posAdjustmentDetails.size() > 0}">
                <c:forEach items='${posAdjustmentSalesReturnMaster.posAdjustmentDetails}' var='posAdjustmentDetails' varStatus='varStatus'>
