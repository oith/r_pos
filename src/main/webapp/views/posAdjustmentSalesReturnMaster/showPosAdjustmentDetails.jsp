...
<c:if test='${not empty posAdjustmentSalesReturnMaster.posAdjustmentDetails}'>
    <div class='box-body table-responsive no-padding'>
        <table class='table table-bordered table-striped table-hover table-condensed dt-responsive display nowrap th-center'>
            ...
            <tbody>
                ...
                <c:forEach items='${posAdjustmentSalesReturnMaster.posAdjustmentDetails}' var='posAdjustmentDetails'  varStatus='loopStatus'>
