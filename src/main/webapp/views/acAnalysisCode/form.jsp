...
<html>
    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content-header'><!-- Content Header (Page header) -->
                ...
                <ul class='top-links'>
                    <c:if test="${acAnalysisCode.id !=null}">
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${context}/acAnalysisCode/${_action}/${acAnalysisCode.id}' enctype='multipart/form-data' commandName='acAnalysisCode' method='POST'>
                        <div class='box-body'>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='codeTag'><spring:message code='codeTag' text='Code Tag'/></form:label>
            <form:input class='form-control' path='codeTag' type='text' size='30' maxlength='20'/>
            <form:errors path='codeTag' cssClass='error' element='div'/>
        </div>
    </div>
                        ...
                        <div class='box-footer'>
                            <c:choose>
                                <c:when test="${acAnalysisCode.id !=null}">
                                    <sec:authorize url='/acAnalysisCode/show'>
                                        <a href='${context}/acAnalysisCode/show/${acAnalysisCode.id}' class='btn btn-primary'>
                                            <i class='fa fa-info-circle'></i>
                                            <spring:message code='default.button.show.label' text='Show'/>
                                        </a> 
                                    </sec:authorize> 
                                    <c:if test="${_action =='edit'}">
                                        <sec:authorize url='/acAnalysisCode/edit/${acAnalysisCode.id}'>
                                    ...
                                    <c:if test="${_action =='copy'}">
                                        <sec:authorize url='/acAnalysisCode/copy/${acAnalysisCode.id}'>
                                            <button type='submit' class='btn btn-warning' >
