...
public class ZxLookupController extends _BaseController {
    ...
    private void commonPost(ZxLookup currObject) {
    ...
    @PostMapping("/create")
    public String save(
            @ModelAttribute(MODEL) @Valid ZxLookup currObject,
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                addFeedbackMessage(redirectAttributes, FLASH_SUCCESS, FEEDBACK_MESSAGE_KEY_CREATED, zxLookup.getCode());
                return "redirect:/" + SHOW + "/" + zxLookup.getId();
            } catch (Exception e) {
    ...
    public String update(
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                addFeedbackMessage(redirectAttributes, FLASH_SUCCESS, FEEDBACK_MESSAGE_KEY_EDITED, zxLookup.getCode());
    ...
    public String copied(
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                zxLookup.setId(faker(zxLookup.getId()));
                addFeedbackMessage(redirectAttributes, FLASH_SUCCESS, FEEDBACK_MESSAGE_KEY_COPIED, zxLookup.getCode());
                return "redirect:/" + SHOW + "/" + zxLookup.getId();
            } catch (Exception e) {
                errorHandler(bindingResult, e);
            }
    ...
    public String search(@ModelAttribute(SEARCH_CRITERIA) _SearchDTO searchCriteria, ModelMap model) {
        ...
        List<ZxLookup> zxLookups;
   
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            zxLookups = zxLookupService.search(searchCriteria);
        } else {
            zxLookups = zxLookupService.findAll(searchCriteria);
        }
        ...
        */
        Iterable<ZxLookup> zxLookups = zxLookupService.findAll();
        for (ZxLookup obj : zxLookups) {
    ...
    public String index(ModelMap model) {
        ...
        List<ZxLookup> zxLookups = zxLookupService.findAll(searchCriteria);
